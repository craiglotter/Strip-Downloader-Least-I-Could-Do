            ...
            If BackgroundWorker1.CancellationPending = False Then
                ...
                While currentdate <= DateTimePicker2.Value
                    If BackgroundWorker1.CancellationPending = False Then
                        ...
                        addrs.Add("http://archive.leasticoulddo.com/strips/" & Format(currentdate, "yyyyMMdd") & ".gif")
                        addrs.Add("http://archive.leasticoulddo.com/strips/" & Format(currentdate, "yyyyMMdd") & ".jpg")
